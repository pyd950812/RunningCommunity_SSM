...
<script type="text/javascript" src="static/js/createSpace.js"></script>
				...
				<td width="100%">
					<table width="100%" border="0" style="margin: 5px 0;"
		 			...
		 			<tr>
											<td width="126" align="center" rowspan="3" valign="top"
												...
												<img src="static/images/icon03.gif" width="16" height="16"
													align="right" />
											</td>
		  			...
		  			<form action="MemberspaceController/createMemberspace"   method="post" onsubmit="return commit()" >
					...
					<tr>
						...
						<TD width="50%" align="left">
							<INPUT class=INPUT1 type=text maxLength=14 name=opinion style="width:200;height:25"  />						</TD>
					</tr>
					<TR>
						<TD width="50%" align="right">
						...
						<TD width="50%" align="left">
									...
									<input type="radio" name="runtime" class=radio1	value="黄昏" />黄昏						</TD>
					</TR>
					<TR>
						<TD width="50%" align="right">
					...
					<TR>
						...
						<TD align="left">
							<input type="file" id="icon" name="icon" style="width:200;height:25" />
							<input type="hidden" id="myfile" name="myfile" style="width:200;height:25" />							</TD>
					</TR>									
    				<tr>
						<td colSpan="2">
							<div align="center">
								<input type="submit" name="sub" value="提交" style="cursor: hand"/>
								&nbsp;&nbsp;
