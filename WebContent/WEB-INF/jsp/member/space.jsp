						...
						<table width="100%">
							...
							<tr>
								...
								<td colspan="2" height="90">
									<span >&nbsp;&nbsp;&nbsp;
										${memberinfo.memberSpace.runtime }，喜欢一个人在${memberinfo.memberSpace.runplace }跑步，最喜欢体育明星是${memberinfo.memberSpace.runstar }。
										愿意成为我的跑友者请与我(${memberinfo.memberSpace.cellphone })联系。
											本人对跑步的主张是：${memberinfo.memberSpace.opinion }！
									</span>
								</td>
							</tr>
							</tbody>
